...
' ##
' ## Windows Uxtrace Version 4.3.3
' ## Modified by ZWA (Orsyp) 2007/04/16
' ## Bug fix, now can run in a uproc 
'''''''''''
''Constant
'''''''''''
...
'Verifying the uxsetenv.bat location, first find the current directory
Set objShell = WScript.CreateObject("WScript.Shell")
Set objExecObject = objShell.Exec("cmd /c cd")
CURRENT_DIR = objExecObject.StdOut.ReadLine()
