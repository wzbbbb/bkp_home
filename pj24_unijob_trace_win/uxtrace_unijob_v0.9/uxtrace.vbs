' ## Windows Uxtrace for UNIJOB Version 0.09
...
If objFSO.FileExists(".\env.bat") Then
	'wscript.echo "uxsetenv.bat is in this dir."
	env_path="."
Elseif objFSO.FileExists("..\env.bat") then
	env_path=".."
else
	if batch_mode="no" then
...
objShell.Run("%comspec% /k .\uxtrace_step1.bat X "& file_level &" "& target &" "& env_path &""), 1, True
