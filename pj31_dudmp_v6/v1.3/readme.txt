...
To run in a non-standard test environment. 
1. Create a link /v6_kit to the unpacked 6.0.05 kit
2. Unpack the uxtrace
3. Put the template file in the "DUFILES" directory
4. Update the template file to specify the installation directory
5. Launch the tool in DUFILES directory:
dudmp6 [Node_Name] [Company_Name]
