...
trace_name=  "TMP_" & S_NOEUD & "_uxtrace_Win_" &"_"& current_time & "_" & file_level 
...
trace_log "################################################################## "
trace_log "***********                                            *********** "
trace_log "***********     Welcome to Uxtrace for SAP Manager 0.9 *********** "
...
'	End If
	...
	Select Case file_level 
	    ...
	    case 2 'copy the data files and the *.trc files 
		cmd_ "copy " & UXSAP_JNL_FILE & " " & dufiles_dir
		cmd_ "copy " & UXSAP_HST_FILE & " " & dufiles_dir
		cmd_ "copy " & UXSAP_EVT_FILE & " " & dufiles_dir
		cmd_ "copy " & WINDIR & "\system32\*.trc " & dufiles_dir
