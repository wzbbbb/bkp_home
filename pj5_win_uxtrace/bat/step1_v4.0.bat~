...
set U_DIR_ANALYSIS=%UXMGR%\WIN_TRACE_%S_NOEUD%_%TRACE_DATE%_%1_%2_%3
...
:FIN
if target==A cscript //nologo //E:vbscript  ./step2_v4.0.vbs %U_DIR_ANALYSIS% 
if target==O cscript //nologo //E:vbscript  ./step2_v4.0.vbs %U_DIR_ANALYSIS% 
pause
