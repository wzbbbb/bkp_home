...
For Each obj_ps in col_ps_lst
	...
	If Err <> 0 Then
		obj_tr_file.writeline Err.Number & " -- " &  Err.Description
		obj_tr_file.writeline "VBS can not extract this process object."
	    Err.Clear
	else
...
win_trace_ver="Windows Uxtrace 4.3.0"
ver_short="v40"
...
trace_log "################################################################## "
trace_log "***********                                            *********** "
trace_log "***********     Welcome to Windows Uxtrace 4.3.0       *********** "
...
If file_level <> 0 then
	...
	Select Case file_level 
	    ...
	    case 9 
		    file_list= array("fecd", "fecl", "fmca", "fmcm", "fmcx", "fmer", "fmev", "fmfu", "fmhs", "fmlc", "fmlp", "fmpf", "fmph", "fmpi", "fmpl", "fmsb", "fmse", "fmsp", "fmta", "fmtp", "fmtr", "fppf", "frup", "fseu", "fupr", "fach", "fapg", "fapr", "fatr", "fmeq", "fmqp", "fmqr", "fmrl", "frra", "frre", "frrv", "fsec", "ftru", "fttg", "ftts", "fuec")
	End Select	
